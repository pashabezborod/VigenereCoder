...
public class SwingUserView extends JFrame implements UserView {
    ...
    @Override
    public void callErrorMessage(String message, boolean isCritical, Exception e) {
        SwingMessage.showErrorMessage(message, isCritical, e, this);
    }
    ...
    public void initialize() {
        ...
        names.addPopupMenuListener(new PopupMenuListener() {
            ...
            @Override
            public void popupMenuWillBecomeInvisible(PopupMenuEvent e) {initializePasswordField();}
            @Override
            public void popupMenuCanceled(PopupMenuEvent e) {initializePasswordField();}});
        ...
        yourPassword.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                Toolkit.getDefaultToolkit()
                        .getSystemClipboard()
                        .setContents(
                                new StringSelection(yourPassword.getText()),
                                null
                        );
        ...
        buttonNewPass.addActionListener(e -> {
            ...
            initializePasswordField();
            newPassword.setText("Password to add"); newPassName.setText("Password name");
        });
        ...
        buttonChangeCrypt.addActionListener(e -> connector.changeCrypt
                (SwingMessage.getInputData("Enter your new crypt", "Crypt changing", this)));
